...
$campaigns = Helpers::getCampaigns(['post_status' => 'any']);
...
foreach ($campaigns as $post):
    ...
    $campaignClass = ".hurrytimer-campaign-{$campaign->getId()}";
    ?>
...
// ------------------------------------------------
    ...
    .hurrytimer-sticky-<?php echo $campaign->getId() ?> {
    ...
    .hurrytimer-sticky-<?php echo $campaign->getId() ?> .hurrytimer-sticky-close svg{
...
<?php else: ?>
    margin-<?php echo $campaign->campaignDisplay === "inline" ? 'right'
        : 'bottom' ?>: <?php echo $campaign->headlineSpacing; ?>px;
<?php endif; ?>
...
<?php endif; ?>
    ...
    padding: <?php echo $campaign->callToAction['y_padding'] . 'px '
                        . $campaign->callToAction['x_padding'] ?>px;
    }
