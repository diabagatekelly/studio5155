...
class Admin
{
    ...
    public function __construct( $pluginName, $version )
    {
        ...
        //removeIf(pro)
        add_filter( 'plugin_action_links_' . HURRYT_BASENAME, [
            $this,
            'pluginLinks',
        ] );
        //endRemoveIf(pro)
    ...
    private function get_menu_position( $start, $increment = 0.3 )
    {
        $menus_positions = [];
