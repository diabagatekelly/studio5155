    ...
    <table class="form-table  hidden mode-settings" data-for="hurrytModeEvergreen">
        ...
        <?php if($post_id !== null): ?>
            <tr class="form-field">
                ...
                <td>
                    <div>
                        <button type="button" data-cookie="<?php echo CookieDetection::cookieName($post_id) ?>" data-url="<?php echo $resetCampaignCurrentAdminUrl ?>" class="button button-default" id="hurrytResetCurrent">Only for me</button>
                        &nbsp;
